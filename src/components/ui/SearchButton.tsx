...
export const SearchButton: React.FC = () => {
  ...
  return (
    <button
     ...
     className="flex items-center gap-3 px-4 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition-all duration-200 group min-w-[160px] lg:min-w-[200px]"
      title="חיפוש (Ctrl+K)"
    >
