          ...
          <div className="lg:col-span-1">
            <div className="flex items-center mb-6">
              ...
              <div>
                <div className="font-bold text-xl">
                  <span className="text-white font-bold">ערן פיקסר</span>
                </div>
                <div className="text-gray-300 text-sm font-bold">פתרונות דיגיטליים</div>
              </div>
            </div>
            
            <p className="text-gray-200 mb-6 leading-relaxed font-bold">
            ...
            <div className="space-y-3">
              <a 
                ...
                className="flex items-center text-gray-200 hover:text-white transition-colors group font-bold"
              >
            ...
            <ul className="space-y-3">
              {footerLinks.services.map((link) => (
                <li key={link.name}>
                  <a 
                    href={link.href}
                    className="text-gray-200 hover:text-white transition-colors hover:translate-x-1 transform duration-200 block font-bold"
                  >
                    {link.name}
                  </a>
                </li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {localServices.map((service) => (
              ...
              >
                <div className="text-sm text-gray-200 group-hover:text-white transition-colors font-bold">
                  {service.name}
                </div>
              </a>
            ))}
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 overflow-hidden">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {partnerSites.map((site) => (
              ...
              >
                <div className="text-sm text-gray-200 group-hover:text-white transition-colors break-words font-bold">
                  {site.name}
                </div>
              </a>
            ))}
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-6 space-x-reverse mb-6 md:mb-0">
              <span className="text-gray-200 font-bold">עקבו אחרינו:</span>
