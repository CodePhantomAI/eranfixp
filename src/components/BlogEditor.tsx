          ...
          <div className="bg-gray-50 p-3 rounded-lg">
            ...
            <div className="space-y-2">
              <button
                type="button"
                onClick={() => {
                  setImageUrl('https://res.cloudinary.com/eranfixer/image/upload/v1/business/technology-workspace')
                  setImageAlt('סביבת עבודה טכנולוגית מתקדמת')
                }}
                className="w-full text-right p-2 bg-white rounded hover:bg-blue-50 transition-colors text-sm"
              >
                💻 סביבת עבודה טכנולוגית
              </button>
              <button
                type="button"
                onClick={() => {
                  setImageUrl('https://res.cloudinary.com/eranfixer/image/upload/v1/business/team-collaboration')
                  setImageAlt('עבודת צוות ושיתוף פעולה')
                }}
                className="w-full text-right p-2 bg-white rounded hover:bg-blue-50 transition-colors text-sm"
              >
              ...
              <button
                type="button"
                onClick={() => {
                  setImageUrl('https://res.cloudinary.com/eranfixer/image/upload/v1/business/digital-marketing')
                  setImageAlt('שיווק דיגיטלי ואנליטיקה')
                }}
                className="w-full text-right p-2 bg-white rounded hover:bg-blue-50 transition-colors text-sm"
              >
                📊 שיווק דיגיטלי ואנליטיקה
              </button>
              <button
                type="button"
                onClick={() => {
                  setImageUrl('https://res.cloudinary.com/eranfixer/image/upload/v1/business/consulting-meeting')
                  setImageAlt('פגישת ייעוץ עסקי')
                }}
                className="w-full text-right p-2 bg-white rounded hover:bg-blue-50 transition-colors text-sm"
              >
                🤝 פגישת ייעוץ עסקי
